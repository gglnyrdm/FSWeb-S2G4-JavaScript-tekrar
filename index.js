...
var ucebolunenlerintoplami = ucetambolunenler.reduce(function(total,item){
	return total + item
});
	
	//3d çözümü
	
var besyuzdenkucuksayilar = sayilar.filter(items);
...
function tekrarBul(sayilar){
	var tekraredensayilar = new Set(sayilar);
